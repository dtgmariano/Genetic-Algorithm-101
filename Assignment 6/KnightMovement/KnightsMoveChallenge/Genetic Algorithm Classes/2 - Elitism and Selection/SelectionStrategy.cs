...
namespace GA
{
    static public class SelectionStrategy
    {
        ...
        public static List<Individual> doSelection(Ops _method, List<Individual> _population, int _selectionSize, int _numberofPlayers, Random _random)
        {
            ...
            switch (_method)
            {
                case Ops.Tournament:
                    {
                        parents = Tournament(_population, _selectionSize, _numberofPlayers, _random);
                    }
                    break;
                case Ops.RouletteWheel:
                    {
                        parents = RouletteWheel(_population, _selectionSize, _random);
                    }
                    break;
            }
        ...
        private static List<Individual> Tournament(List<Individual> _population, int _selectionSize, int _numberofPlayers, Random _random)
        {
        ...
        private static List<Individual> RouletteWheel(List<Individual> _population, int _selectionSize, Random _random)
        {
            List<Individual> parents = new List<Individual>();
