...
namespace GA
{
    public class GA
    {
        ...
        /*Constructors*/
        public GA(int _popsize, int _numgenerations, double _probcrossover, double _probmutation,
        ...
        public void beginStep()
        {
            ...
            for (int i = 0; i < this.popsize; i++)
                population.Add(new Chromossome(this.random));
            ...
            if (parents.Count() % 2 == 0) // Even number of parents
            {
                for (int i = 0; i < (parents.Count() / 2); i++)
                {
                    ...
                    if (dice <= this.probcrossover)
                    {
                        ...
                        offspring.Add(new Chromossome(genes_offspring1));
                        offspring.Add(new Chromossome(genes_offspring2));
                    }
                    else
                    {
        ...
        public void singlebit()
        {
            ...
            mutant = new List<Chromossome>(offspring);
        }
